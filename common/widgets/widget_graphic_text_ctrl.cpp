...
/*******************************************************/
WIDGET_GRAPHIC_TEXT_CTRL::WIDGET_GRAPHIC_TEXT_CTRL( wxWindow*       parent,
...
WIDGET_GRAPHIC_TEXT_CTRL::~WIDGET_GRAPHIC_TEXT_CTRL()
{
...
wxString WIDGET_GRAPHIC_TEXT_CTRL::FormatSize( EDA_UNITS_T aUnit, int textSize )
{
...
void WIDGET_GRAPHIC_TEXT_CTRL::SetTitle( const wxString& title )
{
    m_Title->SetLabel( title );
}


void WIDGET_GRAPHIC_TEXT_CTRL::SetValue( const wxString& value )
{
    m_FrameText->SetValue( value );
}


void WIDGET_GRAPHIC_TEXT_CTRL::SetValue( int textSize )
{
    wxString value = FormatSize( m_UserUnit, textSize );
...
const wxString WIDGET_GRAPHIC_TEXT_CTRL::GetText() const
{
...
int WIDGET_GRAPHIC_TEXT_CTRL::ParseSize( const wxString& sizeText, EDA_UNITS_T aUnit )
{
    int    textsize;
...
int WIDGET_GRAPHIC_TEXT_CTRL::GetTextSize()
{
    return ParseSize( m_FrameSize->GetValue(), m_UserUnit );
}


void WIDGET_GRAPHIC_TEXT_CTRL::Enable( bool state )
{
